...
private ImageFileCache imageFileCache = new ImageFileCache();
    ...
    public LoadDataService(int width, DBManager dbManager) {
    super();
    this.width = width;
    ...
    ImageGetter imgGetter = new Html.ImageGetter() {
        public Drawable getDrawable(String source) {
            ...
            drawable.setBounds(0, 0, width , (int) (1.0*width*drawable.getBitmap().getHeight()/drawable.getBitmap().getWidth()) );
            return drawable;
        }
    };
    
    private void initData(String url) throws ClientProtocolException, IOException, JSONException{
...
//            Spanned content = Html.fromHtml(news.getContent().replaceAll("&nbsp;", ""),imgGetter,null); 
